...
import 'package:nabeelaljirbi_app/feature/patient/subscription/model/platform_subscription_model.dart';
...
class PatientSubscriptionController extends GetxController {
  var selectedPlanId = ''.obs;
  var selectedPlanAmount = Rx<num>(0);
  var usdAmount = Rx<num>(0);
  var isLoading = false.obs;
  var subscriptionPlan = Rx<PlatformSubscription?>(null);
  ...
  Future<void> fetchSubscriptionPlans() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final subscriptionResponse = PlatformSubscriptionResponse.fromJson(
          decodedData,
        );
  ...
  Future<void> topUpPrepaidCard() async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        final profileController = Get.put(PatientProfileController());
        await profileController.fetchProfile();
        final subscriptionController = Get.put(DoctorProfileController());
        await subscriptionController.fetchProfile();
