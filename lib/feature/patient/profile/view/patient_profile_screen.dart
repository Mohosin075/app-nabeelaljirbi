...
import 'package:nabeelaljirbi_app/feature/patient/profile/view/patient_profile_info_screen.dart';
import 'package:nabeelaljirbi_app/feature/patient/profile/view/patient_referral_program_screen.dart';
import 'package:nabeelaljirbi_app/feature/patient/profile/view/patient_help_center_screen.dart';
import 'package:nabeelaljirbi_app/feature/patient/profile/view/patient_legal_screen.dart';
        ...
        child: Obx(
          () =>
              controller.isLoading.value &&
                  controller.patientProfile.value == null
              ? const Center(
                          ...
                          child: Column(
                            children: [
                              _buildMenuItem(
                                ...
                                onTap: () {
                                  Get.to(() => PatientProfileInfoScreen());
                                },
                              ),
                              ...
                              _buildMenuItem(
                                ...
                                title: 'refer'.tr,
                                onTap: () {
                                  Get.to(() => PatientReferralProgramScreen());
                                },
                                hasSubtitle: true,
                              ),
                              ...
                              _buildMenuItem(
                                ...
                                onTap: () {
                                  Get.to(() => PatientHelpCenterScreen());
                                },
                              ),
                              const Divider(color: Color(0xffF3F4F6)),
                              _buildMenuItem(
