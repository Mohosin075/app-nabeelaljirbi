...
class DoctorReferralProgramScreen extends StatelessWidget {
  const DoctorReferralProgramScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [_buildReferralSection(controller)]),
      ),
    );
  }
