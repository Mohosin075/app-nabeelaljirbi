...
import 'package:nabeelaljirbi_app/feature/doctor/profile/controller/doctor_insurance_controller.dart';

class DoctorInsuranceScreen extends StatelessWidget {
  const DoctorInsuranceScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(DoctorInsuranceController());
  ...
  void _addInsuranceBottomSheet(
    ...
    DoctorInsuranceController controller,
  ) {
    Get.bottomSheet(
      Container(
        padding: const EdgeInsets.all(20),
