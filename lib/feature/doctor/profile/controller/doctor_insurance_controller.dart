...
class DoctorInsuranceController extends GetxController {
  var isLoading = false.obs;
  var isAdding = false.obs;
  var insurances = <InsuranceItem>[].obs;
  ...
  Future<void> fetchInsurances() async {
    ...
    try {
      ...
      final url = '${Urls.baseUrl}/doctor/insurance';

      debugPrint('Fetching Doctor Insurances from: $url');
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true && data['data'] != null) {
          ...
          insurances.assignAll(
            list.map((e) => InsuranceItem.fromJson(e)).toList(),
          );
        }
      }
    } catch (e) {
  ...
  Future<void> addInsurance() async {
    ...
    try {
      ...
      final String url = '${Urls.baseUrl}/doctor/insurance';
...
class InsuranceItem {
  ...
  InsuranceItem({this.id, this.insuranceDetails, this.image});

  InsuranceItem.fromJson(Map<String, dynamic> json) {
    id = json['id'];
