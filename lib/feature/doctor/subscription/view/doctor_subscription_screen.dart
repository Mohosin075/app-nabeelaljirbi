...
import 'package:nabeelaljirbi_app/feature/doctor/subscription/controller/doctor_subscription_controller.dart';

class DoctorSubscriptionScreen extends StatelessWidget {
  const DoctorSubscriptionScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(DoctorSubscriptionController());
