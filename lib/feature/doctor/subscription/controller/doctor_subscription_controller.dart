...
import 'package:nabeelaljirbi_app/feature/doctor/subscription/model/platform_subscription_model.dart';
import 'dart:convert';
...
class DoctorSubscriptionController extends GetxController {
  var selectedPlanId = ''.obs;
  var selectedPlanAmount = Rx<num>(0);
  var usdAmount = Rx<num>(0);
  var isLoading = false.obs;
  var subscriptionPlan = Rx<DoctorSubscription?>(null);
  ...
  Future<void> fetchSubscriptionPlans() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final subscriptionResponse = DoctorSubscriptionResponse.fromJson(
          decodedData,
        );
