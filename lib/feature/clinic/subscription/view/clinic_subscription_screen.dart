...
import 'package:nabeelaljirbi_app/feature/clinic/subscription/controller/clinic_subscription_controller.dart';

class ClinicSubscriptionScreen extends StatelessWidget {
  const ClinicSubscriptionScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(ClinicSubscriptionController());
